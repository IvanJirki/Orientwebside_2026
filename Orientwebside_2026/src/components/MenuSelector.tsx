...
export const MenuSelector = ({ menuSections }: MenuSelectorProps) => {
  ...
  return (
      ...
      <div className="space-y-2 text-center sm:space-y-3">
        <h2 className="text-2xl font-bold text-black drop-shadow-sm dark:text-white dark:drop-shadow-md dark:[text-shadow:0_2px_4px_rgba(255,255,255,0.2),0_1px_2px_rgba(255,255,255,0.15)] sm:text-3xl md:text-4xl">
          {t('selectPromptTitle')}
        </h2>
        <p className="mx-auto max-w-2xl px-1 text-sm text-black/90 drop-shadow-sm dark:text-muted-foreground sm:text-base">
