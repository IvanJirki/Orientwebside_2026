  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden py-12 md:py-20">
        ...
        <div className="absolute inset-0 z-0 bg-white dark:bg-orient-dark">
          <div 
              ...
              style={{
                backgroundImage: `
                  repeating-linear-gradient(
                    ...
                    transparent,
                    transparent 60px,
                    rgba(255, 0, 0, 0.15) 60px,
                    rgba(255, 0, 0, 0.15) 62px
                  ),
                  repeating-linear-gradient(
                    -45deg,
                    transparent,
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-white/80 via-orient-red/10 to-white/80 dark:from-orient-dark/70 dark:via-orient-red/15 dark:to-orient-dark/70"></div>
        </div>
        ...
        <div className="relative z-10 container mx-auto max-w-3xl px-4 sm:px-6">
          <div className="mx-auto max-w-3xl space-y-6 text-center sm:space-y-8">
            <h2 className="mb-4 text-3xl font-bold text-gray-900 dark:text-white sm:text-4xl" style={{ textShadow: '2px 2px 8px rgba(255,0,0,0.3)' }}>
              {t('aboutWelcomeTitle')}
            </h2>
            <p className="mb-4 text-base leading-relaxed text-gray-700 dark:text-white/90 sm:text-lg" style={{ textShadow: '1px 1px 4px rgba(255,0,0,0.2)' }}>
              {t('aboutParagraph1')}
            </p>
            <p className="mb-4 text-base leading-relaxed text-gray-700 dark:text-white/90 sm:text-lg" style={{ textShadow: '1px 1px 4px rgba(255,0,0,0.2)' }}>
              {t('aboutParagraph2')}
            </p>
            <p className="text-base leading-relaxed text-gray-700 dark:text-white/90 sm:text-lg" style={{ textShadow: '1px 1px 4px rgba(255,0,0,0.2)' }}>
              {t('aboutParagraph3')}
            </p>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-orient-red/5 via-white to-orient-yellow/5 py-12 dark:from-orient-dark dark:via-orient-dark/95 dark:to-orient-dark sm:py-16">
        <div className="container mx-auto max-w-5xl px-4 sm:px-6">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="mb-6 text-2xl font-bold text-gray-900 dark:text-white sm:mb-8 sm:text-3xl" style={{ textShadow: '2px 2px 8px rgba(255,0,0,0.3)' }}>
              {t('followUs')}
            </h2>
